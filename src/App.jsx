...
function App() {
  ...
  const handleModalClose = (event) => {
    if (
      event &&
      modal1Ref.current &&
      !modal1Ref.current.contains(event.target)
    ) {
      if (isModalOpen) {
        setIsModalOpen(false);
      }
        ...
        <div className="container1">
          <div className="list">
            ...
            >
              ...
              <div
                className={`bear ${showNicky ? "icon-hidden" : "icon-visible"}`}
              >
                <RiBearSmileLine />
              </div>
            </div>
            <div className="icons">
              ...
              >
                <BsFillPersonFill
                  style={{ fontSize: "30px", margin: "10px" }}
                />
                <div className="icon-text" style={iconStyle("profile")}>
                  個人檔案
                </div>
              </div>
              <div
              ...
              <div className="modal-content">
                ...
                <div className="modal-footer">
                  ...
                  <button
                    ...
                    onClick={submit}
                    data-bs-dismiss={isImageUploaded ? "modal" : undefined}
                  >
                    確認
                  </button>
                </div>
